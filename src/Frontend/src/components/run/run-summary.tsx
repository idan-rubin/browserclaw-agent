...
import type { ConsoleEntry, SkillOutput, RunStatus } from "./types";
...
interface RunSummaryProps {
  ...
  skillStats: { llm_calls?: number } | null;
}

export function RunSummary({ status, answer, error, duration, entries, skill, skillStats }: RunSummaryProps) {
